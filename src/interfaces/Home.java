...
public class Home extends javax.swing.JFrame {
    ...
    public Home() {
        initComponents();
        try {
//            jLabel1.setSize(jDesktopPane1.getSize());
            BufferedImage bi = ImageIO.read(new File("src/images/5.jpg"));
    ...
    private void initComponents() {
        ...
        setTitle("Gym And Sport Management System");
    ...
    private void jMenuItem16ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jMenuItem16ActionPerformed
        try {
            JasperReport r = JasperCompileManager.compileReport("G:\\SLIIT\\2nd Year 1st Sem\\2016\\ST 2\\Assignment\\GymAndSportManagementSystem\\src\\reports\\DetailedMemberReport.jrxml");
    ...
    private void jMenuItem20ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jMenuItem20ActionPerformed
        try {
            JasperReport r = JasperCompileManager.compileReport("G:\\SLIIT\\2nd Year 1st Sem\\2016\\ST 2\\Assignment\\GymAndSportManagementSystem\\src\\reports\\PlanB.jrxml");
            JasperPrint jp = JasperFillManager.fillReport(r, null, JDBC.getCon());
            JasperViewer.viewReport(jp, false);
        } catch (Exception e) {
            e.printStackTrace();
    ...
    private void jMenuItem17ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jMenuItem17ActionPerformed
        try {
            JasperReport r = JasperCompileManager.compileReport("G:\\SLIIT\\2nd Year 1st Sem\\2016\\ST 2\\Assignment\\GymAndSportManagementSystem\\src\\reports\\PlanA.jrxml");
            JasperPrint jp = JasperFillManager.fillReport(r, null, JDBC.getCon());
            JasperViewer.viewReport(jp, false);
        } catch (Exception e) {
            e.printStackTrace();
    ...
    private void jMenuItem21ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jMenuItem21ActionPerformed
        try {
            JasperReport r = JasperCompileManager.compileReport("G:\\SLIIT\\2nd Year 1st Sem\\2016\\ST 2\\Assignment\\GymAndSportManagementSystem\\src\\reports\\PlanC.jrxml");
            JasperPrint jp = JasperFillManager.fillReport(r, null, JDBC.getCon());
            JasperViewer.viewReport(jp, false);
        } catch (Exception e) {
            e.printStackTrace();
